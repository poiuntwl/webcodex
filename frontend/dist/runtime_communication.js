...
export function deliveryAgentLabel(agentId, agents = []) {
...
export function createAgentRow(agent, selectedAgentId, options) {
...
export function renderAgentRows(list, agents, selectedAgentId, options) {
    if (!list)
        return;
...
export function createConversationRow(conversation, selectedConversationId, options) {
...
export function renderConversationRows(list, conversations, selectedConversationId, options) {
    if (!list)
        return;
    while (list.firstChild)
        list.removeChild(list.firstChild);
...
export function createConversationMessageCard(message, agents, options = {}) {
    const language = options.language;
...
export function renderConversationMessages(transcript, messages, agents, options = {}) {
    if (!transcript)
        return;
...
export function createInboxDeliveryCard(item, agents, options) {
    const language = options.language;
...
export function renderInboxDeliveryCards(container, inbox, agents, options) {
    if (!container)
        return;
