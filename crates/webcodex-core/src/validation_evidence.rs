...
pub const PARSER_KIND: &str = "structured_validation_parser";
pub const PARSER_VERSION: u8 = 3;
pub const PARSER_LIMITATIONS: [&str; 3] = [
...
pub const NO_STABLE_DIAGNOSTICS_REASON: &str = "no stable diagnostics found";
...
pub struct ValidationDiagnostics {
    ...
    #[serde(skip_serializing_if = "Option::is_none")]
    pub test_summary: Option<CargoTestSummary>,
    ...
    pub failed_test_details_truncated: bool,
    #[serde(skip_serializing_if = "Option::is_none")]
...
pub fn parse_cargo_test_diagnostics(
    stdout_excerpt: &str,
    stderr_excerpt: &str,
    truncated: bool,
) -> ValidationDiagnostics {
...
pub fn parse_go_test_diagnostics(stdout_excerpt: &str, truncated: bool) -> ValidationDiagnostics {
...
pub fn aggregate_cargo_test_summaries<'a, I>(lines: I) -> Option<CargoTestSummary>
where
...
pub fn parse_complete_cargo_test_summary_counts(line: &str) -> Option<(u64, u64)> {
    let line = sanitize_line(line);
