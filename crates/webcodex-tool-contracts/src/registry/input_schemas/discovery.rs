...
pub fn tool_manifest_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "tool_name": {
...
pub fn list_projects_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "client_id": {
...
pub fn runtime_status_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "client_id": {
...
pub fn read_tool_trace_input_schema() -> Value {
    json!({
        "type": "object",
        "properties": {
            "trace_ref": {
