...
bounded PNG, JPEG, or WebP as native image content. Office artifacts such as DOCX/PPTX/XLSX and PDFs
use the same artifact transport and can therefore move between a project and a
